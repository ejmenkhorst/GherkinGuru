...
Do not use technical terms in your step descriptions, a non-technical person needs to understand the behavior of the software.

## 5. Describe what the software does not how
Describe what the software does not how - avoid UI related terminology like click on, press button etc.

## Output format
The model should output only the `.feature` file content — no
explanations, no markdown code fences, no preamble text.